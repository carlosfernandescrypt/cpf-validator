...
public class Versao10Threads {
    public static void main(String[] args) {
        ...
        System.out.println("Versão 10 Threads - Iniciando processamento de " + todosArquivos.size() + " arquivos...");
        ...
        for (int i = 0; i < todosArquivos.size(); i++) {
            arquivosPorThread.get(i % 10).add(todosArquivos.get(i));
        }
        
        long inicio = System.currentTimeMillis();
        
        CPFProcessorThread[] threads = new CPFProcessorThread[10];
        for (int i = 0; i < 10; i++) {
        ...
        ResultWriter.salvarTempoExecucao("versao_10_threads.txt", tempoExecucao);
    }
} 