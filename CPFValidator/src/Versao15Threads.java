...
public class Versao15Threads {
    public static void main(String[] args) {
        ...
        System.out.println("Versão 15 Threads - Iniciando processamento de " + todosArquivos.size() + " arquivos...");
        ...
        for (int i = 0; i < todosArquivos.size(); i++) {
            arquivosPorThread.get(i % 15).add(todosArquivos.get(i));
        }
        
        long inicio = System.currentTimeMillis();
        
        CPFProcessorThread[] threads = new CPFProcessorThread[15];
        for (int i = 0; i < 15; i++) {
        ...
        ResultWriter.salvarTempoExecucao("versao_15_threads.txt", tempoExecucao);
    }
} 