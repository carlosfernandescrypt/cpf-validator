...
public class Versao5Threads {
    public static void main(String[] args) {
        ...
        System.out.println("Versão 5 Threads - Iniciando processamento de " + todosArquivos.size() + " arquivos...");
        ...
        for (int i = 0; i < todosArquivos.size(); i++) {
            arquivosPorThread.get(i % 5).add(todosArquivos.get(i));
        }
        
        long inicio = System.currentTimeMillis();
        
        CPFProcessorThread[] threads = new CPFProcessorThread[5];
        for (int i = 0; i < 5; i++) {
        ...
        ResultWriter.salvarTempoExecucao("versao_5_threads.txt", tempoExecucao);
    }
} 